...
**The result?** AI suggestions that are tailored to _your actual enterprise environment_.
...
```json
{
  "mcp.servers": {
    "microsoft-graph": {
      "command": "node",
      "args": ["/path/to/mcp-server-graph/dist/index.js"],
      "env": {
...
_Estimated time: 25 minutes • Difficulty: Intermediate • Next: Build Your Portal_
