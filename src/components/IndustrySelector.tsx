      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Build a functional web app for your industry in minutes using AI-powered coding.
            Select your industry to get started with a customized template.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-500 text-sm">
            🤖 Powered by GitHub Copilot • ⚡ Built with Vite + React + TypeScript + Tailwind
          </p>
        </div>
      </div>
    </div>
